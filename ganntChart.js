...
function addRow() {
  ...
  + '</td><td>'
  + (lastRowNumebr + 1)
  + '</td><td><input class="exectime form-control" type="text"/></td><td class="servtime"></td>'
  //if ($('input[name=algorithm]:checked', '#algorithm').val() == "priority")
  + '<td class="priority-only"><input class="form-control" type="text"/></td></tr>';
